...
Spannable=luajava.bindClass "android.text.Spannable"
Toast=luajava.bindClass "android.widget.Toast"
EditText=luajava.bindClass "android.widget.EditText"
InputMethodManager=luajava.bindClass "android.view.inputmethod.InputMethodManager"
...
LuaAdapter=luajava.bindClass "com.androlua.LuaAdapter"
...
ForegroundColorSpan=luajava.bindClass "android.text.style.ForegroundColorSpan"
PageView=luajava.bindClass "android.widget.PageView"
Window=luajava.bindClass "android.view.Window"
table=require "table"
SpannableStringBuilder=luajava.bindClass "android.text.SpannableStringBuilder"
typedValue = luajava.newInstance('android.util.TypedValue')
...
dark=luajava.getContext().getResources().getConfiguration().uiMode& Configuration.UI_MODE_NIGHT_YES!=0
tcolor=typedValue.data
bcolor=0xfff1f3f6
...
print_adp=LuaAdapter(this,print_data,{
  TextView;
  layout_width='fill';
  textSize='12dp';
  padding="5dp";
...
date=""--SimpleDateFormat("HH:mm:ss.SSS: ")
...
variable_node={}
variable_data={}
variable_adp=LuaAdapter(this,variable_data,{
  TextView;
  layout_width='fill';
  textSize='12dp';
  padding="5dp";
...
items={"All","Lua","Tcc","Error","Warning","Info","Debug","Verbose"}
types={'',"lua:* *:S","tcc:* *:S","*:E","*:W","*:I","*:D","*:V"}

logcat_text={}
logcat_data={}
logcat_adp=LuaAdapter(this,logcat_data,{
  TextView;
  layout_width='fill';
  textSize='12dp';
  padding="5dp";
...
v=ids.dia.logcat_bar.getChildAt(0)
...
ids.btn.root.onClick=function(v)
 ...
 bar={'prints', 'variable', 'logcat', 'text', 'control' }
...
ids.dia.control_run.onClick=function(v)
  振动(v)
  if(ids.dia.control_code.text=="help")
    then
    Toast.makeText(activity,"输入vft=true可开启振动。",1).show();
    ids.dia.control_code.text=""
   elseif(ids.dia.control_code.text=="copy variable data")
    then
    activity.getSystemService(Context.CLIPBOARD_SERVICE).setText(table.concat(variable_data,"\n"))
   else
    local f,e=load(--[[[[function print(s)
