...
public class LuaWebView extends WebView implements LuaGcable
{
    ...
    public LuaWebView(LuaActivity context)
	{
        ...
        setWebChromeClient(new SimpleLuaWebChromeClient(new LuaWebChromeClient(){
	...
	public void setWebChromeClient(LuaWebChromeClient client)
	{
        // TODO: Implement this method
        super.setWebChromeClient(new SimpleLuaWebChromeClient(client));
    }
	...
	public    class SimpleLuaWebChromeClient extends WebChromeClient
	{    
		EditText prompt_input_field = new EditText(mContext);
		private LuaWebView.LuaWebChromeClient mLuaWebChromeClient=null;

		public SimpleLuaWebChromeClient(LuaWebChromeClient wvc)
		{
			mLuaWebChromeClient = wvc;
		}

        @Override
        public boolean onJsAlert(WebView view, String url, String message, final android.webkit.JsResult result)
		{
			return mLuaWebChromeClient.onJsAlert(view, url, message, result);
		};

        @Override
        public boolean onJsConfirm(WebView view, String url, String message, final JsResult result)
		{
			return mLuaWebChromeClient.onJsConfirm(view, url, message, result);
		};
        ...
        public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, final JsPromptResult result)
		{
            ...
            return mLuaWebChromeClient.onJsPrompt(view, url, message, defaultValue, result);
		}

		public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> valueCallback, FileChooserParams fileChooserParams)
		{

			return mLuaWebChromeClient.onShowFileChooser(webView, valueCallback, fileChooserParams);
		}
        @Override
        public void onProgressChanged(WebView view, int newProgress)
		{
			mLuaWebChromeClient.onProgressChanged(view, newProgress);
        ...
        public void onReceivedTitle(WebView view, String title)
		{
            ...
            mLuaWebChromeClient.onReceivedTitle(view, title);
        ...
        public void onReceivedIcon(WebView view, Bitmap icon)
		{
            ...
            mLuaWebChromeClient.onReceivedIcon(view, icon);
		}
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType)
		{
			mLuaWebChromeClient.openFileChooser(uploadMsg, acceptType);
		}
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg)
		{
			...
			mLuaWebChromeClient.openFileChooser(uploadMsg);
		}

        // For Android  > 4.1.1
        public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture)
		{
			mLuaWebChromeClient.openFileChooser(uploadMsg, acceptType, capture);
		}

	}


	public interface    LuaWebChromeClient 
	{    
		public boolean onJsAlert(WebView view, String url, String message, final android.webkit.JsResult result)
        public boolean onJsConfirm(WebView view, String url, String message, final JsResult result)
        public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, final JsPromptResult result)
