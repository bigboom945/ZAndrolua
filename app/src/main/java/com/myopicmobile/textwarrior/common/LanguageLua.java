...
public class LanguageLua extends Language
{
	...
	private  static String keywordTarget ="and|break|case|continue|default|defer|do|else|elseif|end|false|for|function|goto|if|in|lambda|local|nil|not|or|repeat|return|switch|then|true|until|when|while";
	...
	private final static String extFunctionTarget="activity|call|compile|dump|each|enum|import|loadbitmap|loadlayout|loadmenu|loadGif|service|set|task|thread|timer";
